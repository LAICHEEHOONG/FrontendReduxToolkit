...
import { screenWidthAction } from "../features/mobileMode/mobileSlice";
import '../style/list.css'

const List = () => {
    
    const dispatch = useDispatch();
    const alertStatus = useSelector(state => state.alert.alertStatus);
    const tableStatus = useSelector(state => state.changeTable.tableStatus);
